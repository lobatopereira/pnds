...
class Funsionariu(models.Model):
	...
	areaadministrativepost = models.ForeignKey(AdministrativePost, on_delete=models.CASCADE,null=True,related_name="AreaAdministrativePost",blank=True)
	areamunicipality = models.ForeignKey(Municipality, on_delete=models.CASCADE,null=True,related_name="AreaMunicipality",blank=True)
	areavillage = models.ForeignKey(Village, on_delete=models.CASCADE,null=True,related_name="AreaVillage",blank=True)
